    ...
    <div className="group relative flex w-full max-w-[400px] flex-col overflow-hidden rounded-xl bg-white shadow-md transition-all hover:shadow-lg">
      ...
      <div className="flex min-h-[180px] flex-col gap-3 p-5 md:gap-4">
        {!hidePrice && <div className="flex gap-2">
          ...
          <p className="p-semibold-14 w-max rounded-full bg-grey-500/10 px-4 py-1 text-grey-500 line-clamp-1s">
            {event.category.name}
          </p>
        </div>}

        <p className="p-medium-16 p-medium-18 text-grey-500">
          {event.startDateTime ? formatDateTime(event.startDateTime).dateTime : 'N/A'}
        </p>
