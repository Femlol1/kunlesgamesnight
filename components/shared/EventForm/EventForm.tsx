...
import './EventForm.css'; // Custom CSS for ReactQuill
                            ...
                            <FormItem className="w-full">
                                <FormControl>
                                    <ReactQuill 
                                        ...
                                        className="quill-input-field quill-editor short-quill" 
                                    />
                                </FormControl>
                                <FormMessage />
                            </FormItem>
                            ...
                            <FormItem className="w-full">
                                <FormControl>
                                    <ReactQuill 
                                        ...
                                        className="textarea rounded-2xl quill-editor large-quill" 
                                    />
                                </FormControl>
                                <FormMessage />
                            </FormItem>
